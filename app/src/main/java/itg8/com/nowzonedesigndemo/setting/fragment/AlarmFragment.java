...
public class AlarmFragment extends Fragment implements View.OnClickListener, CommonMethod.alarmListener {
    ...
    private void init(View view) {
        ...
        if (Prefs.getString(CommonMethod.SAVEDAYS, null) != null) {
            String bc = Prefs.getString(CommonMethod.SAVEDAYS, null);
        ...
        if (Prefs.getString(CommonMethod.SAVE_DAYS_FOR_MEDITATION, null) != null) {
            String bc = Prefs.getString(CommonMethod.SAVE_DAYS_FOR_MEDITATION, null);
    ...
    private void checkSharePrefAlarmTime() {
        if (Prefs.getLong(CommonMethod.START_ALARM_TIME, 0) > 0) {
    ...
    private void saveToSharePref(String fromsmartalarm) {
        ...
        if (fromsmartalarm.equalsIgnoreCase(CommonMethod.FROMSMARTALARM)) {
            Prefs.putString(CommonMethod.SAVEDAYS, share);
        } else {
            Prefs.putString(CommonMethod.SAVE_DAYS_FOR_MEDITATION, share);
