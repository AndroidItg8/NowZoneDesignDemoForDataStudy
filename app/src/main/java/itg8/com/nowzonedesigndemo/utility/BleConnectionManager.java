...
import static itg8.com.nowzonedesigndemo.common.CommonMethod.DATA_ENABLE_A4;
...
import static itg8.com.nowzonedesigndemo.common.CommonMethod.VIBRATOR_MED;
import static itg8.com.nowzonedesigndemo.common.CommonMethod.VIBRATOR_SERVICE_UUID;
import static itg8.com.nowzonedesigndemo.common.CommonMethod.VIBRATOR_UUID;
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                case MSG_PRESSURE_ACCEL:
                    ...
                    listener.onDataAvail(characteristic.getValue(), acc);
...
//                if(mState==0){
//
//                    if (gatt.getService(TEMP_SERVICE_UUID).getCharacteristic(DATA_ENABLE).getUuid().toString().substring(7,8).equals("3")) {
//                        characteristic = gatt.getService(TEMP_SERVICE_UUID).getCharacteristic(DATA_ENABLE);
//                        notifycharacteristic(gatt, characteristic);
//
//                    }
//                    else if(gatt.getService(TEMP_SERVICE_UUID).getCharacteristic(DATA_ENABLE_A4).getUuid().toString().substring(7,8).equals("4")){
//                        characteristic = gatt.getService(TEMP_SERVICE_UUID).getCharacteristic(DATA_ENABLE_A4);
//                        notifycharacteristic(gatt, characteristic);
//
//
...
//                    }
            ...
            public void onCharacteristicWrite(BluetoothGatt gatt, BluetoothGattCharacteristic characteristic, int status) {
                ...
                listener.currentState(DeviceState.CHARACTERISTICS_WRITE);
...
//        createFile(value.toString());
    ...
    private boolean writeCharacteristics(UUID serviceUUID, UUID charactUUID, byte[] value) throws NullPointerException {
        ...
        return writeCharacteristic(gattCharacteristic, value);
...
//            mBluetoothGatt=null;
    ...
    @Override
    public void onStartVibrationLow() {
        writeCharacteristics(VIBRATOR_SERVICE_UUID, VIBRATOR_UUID, VIBRATOR_MED);
    }
