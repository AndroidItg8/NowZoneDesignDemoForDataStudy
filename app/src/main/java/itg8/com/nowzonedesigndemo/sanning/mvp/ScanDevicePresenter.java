...
//    };
    ...
    public void startLEScan(Context context, BluetoothAdapter bluetoothAdapter) {
        if (stopped) {
            ...
            model.setBluetoothAdapter(bluetoothAdapter);
    ...
    public void checkAlreadyConnectedOnce(Context context) {
        if(Prefs.getString(CommonMethod.STATE)!=null &&
                !Prefs.getString(CommonMethod.STATE).equalsIgnoreCase(DeviceState.DISCONNECTED.name())){
            //
